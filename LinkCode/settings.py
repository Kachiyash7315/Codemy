"""
Django settings for LinkCode project.
...
SECRET_KEY = 'django-insecure-y!0jx^8fmy-6=@@7h3=l%6bmy=3@duz4=tz!fv!3*@_q#x35xo'
...
WSGI_APPLICATION = 'LinkCode.wsgi.application'
